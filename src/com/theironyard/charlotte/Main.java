...
public class Main {
    ...
    public static void restaurants(Connection conn, String name, String phone, String type, boolean isOpen) throws SQLException {
        PreparedStatement stmt = conn.prepareStatement("SELECT * FROM restaurants ORDER BY ID");

    }
    public static void insertRestaurant(Connection conn, String name, String phone, String type, boolean isOpen) throws SQLException{
        PreparedStatement stmt = conn.prepareStatement("INSERT INTO restaurants VALUES (null, ?, ?, ?, ?)");
